...
Consider the following model that includes a squared term for `Age`, which allows our regression line to change directions once as `Age` changes. We included this term because a graph suggested wages initially increase with age, then decreases.
...
Consider the following log-log regression model.
...
Run this regression model and print the results.
```
